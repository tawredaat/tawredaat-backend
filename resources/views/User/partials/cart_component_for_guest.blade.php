{{-- if this product in user cart  --}}
    @if($product->inCart)
        ...
        <a style="font-weight: bold;" title="remove item" data-route="{{route('user.guest.delete.cart')}}" data-cartitemid="{{$product->cart_item_id}}"  data-shopproductid="{{$product->id}}"   class="yellow-rounded yellow-fill m-2 delete-from-cart-btn">
...
{{-- if this product not in user cart  --}}
    @else
        ...
        <a style="font-weight: bold;" data-route="{{route('user.guest.add.cart')}}" data-shopproductid="{{$product->id}}"   class="yellow-rounded yellow-fill m-2 add-to-cart-btn">
