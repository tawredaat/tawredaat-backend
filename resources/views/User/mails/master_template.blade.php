...
<body
    style='-webkit-text-size-adjust:none;-ms-text-size-adjust:none;border:0;outline:0;background:#fff;min-height:1000px;color:#000;font-family:"system-ui", sans-serif, Arial, Helvetica;font-size:14px;line-height:1.2;margin:0;padding:0;background-color:#f6f9fc;direction:rtl;'>
    ...
    <table class="outer" align="center"
        style='border-spacing:0;padding:0;margin:0 auto;width:100%;max-width:600px;font-family:"system-ui", sans-serif, Arial, Helvetica;background-color:#fff;text-align:center;'>
        <tr>
            <td
        ...
        <tr>
            <td
                style='padding:0;border-collapse:collapse;border-spacing:0px;border:0px none;vertical-align:middle;font-family:"system-ui", sans-serif, Arial, Helvetica !important;text-align: right; padding: 40px 20px;'>
                <p class="sml-text"
                    style='line-height:1.2;margin:0;padding:0;font-family:"system-ui", sans-serif, Arial, Helvetica;font-size:12px;font-weight:300;text-align:right;line-height:1.63;margin-bottom:10px;color:#5c5c5c;font-family:"system-ui", sans-serif, Arial, Helvetica !important;'>
                    مع التحية فريق</p>
        ...
        <tr>
            ...
            text-align: right;
              ...
              margin-bottom: 12px;
            ;'>
                    اذا كان لديكم أي استفسار لا تتردد في التواصل معنا على رقم خدمة
                    العملاء
                                ...
                                <tr class="tawredaat-style">
                                    <td
                                        ...
                                        font-family:"system-ui", sans-serif, Arial, Helvetica !important;font-size: 12px;
                                         '>
                                        جميع الحقوق محفوظة © لشركة {{ $company_name }}
                                    </td>
                                </tr>
                            </table>
                            <!-- COL 2 -->
