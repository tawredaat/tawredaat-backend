...
<body
    ...
    <table class="outer" align="center"
        ...
        <tr>
            <td class="banner"
                ...
                <a href="{{ url(config('global.live_home_page', 'https://tawredaat.com/')) }}" class="tawredaat-style"
                    ...
                    <img src="{{ $logo}}" alt=""
                        style='width:250px;line-height:1.2;margin:0;padding:0;display:block;
        ...
        <tr>
            <td style="">
                <p
                    style='margin:9px;padding:3.5px;border-radius:6px;
                    background-color:{{ $footer_color }};
                    font-weight:bold;line-height:1.2;
                    font-family:"system-ui", sans-serif, Arial, Helvetica;
                    font-family:"system-ui", sans-serif, Arial, Helvetica !important;
                    font-size: 12px;font-weight: 300;text-align: center;
                    line-height: 1.63;color: #fff;margin-bottom: 12px;'>
                    اذا كان لديكم أي أسئلة حول طلبك, فيرجى الاتصال بفريق خدمة
                    العملاء
                    <span>[</span>
                    <a href="tel:{{ $used_phone_number }}"
                    ...
                    او
                    <span>[</span> <a href="mailto:{{ $used_email }}"
                        style='line-height:1.2;margin:0;padding:0;font-family:"system-ui", sans-serif, Arial, Helvetica;text-decoration:none;font-family:"system-ui", sans-serif, Arial, Helvetica !important;font-weight: 500; color: #fff;'>
                        {{ $used_email }}</a> <span>]</span>
                </p>

                <p style="color: {{ $footer_color }};float:left;margin:15px;">
                    <a style="color: {{ config('global.used_app_color', '') }};font-weight:bold;"
                        href="{{ URL(config('global.live_terms_page', 'https://tawredaat.com/terms-and-conditions')) }}">
                        الشروط و الاحكام</a>
                    &nbsp;&nbsp;&nbsp;
                    <a style="color: {{ config('global.used_app_color', '') }};font-weight:bold;"
                        href="{{ URL(config('global.live_faqs_page', 'https://tawredaat.com/')) }}">
                        الاسئلة الشائعة</a>
                </p>
            </td>
        </tr>
