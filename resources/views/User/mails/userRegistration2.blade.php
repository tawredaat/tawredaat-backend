...
<head>
    <title>ED مرحبا بكم في توريدات دوت كوم</title>
        ...
        <tr class="top-section" style="width: 100%">
            <td>
                <img
                        ...
                        src="https://i.ibb.co/MDSVRPG/welcome-1.png"
                />
            </td>
            <td
                    class="subject"
            ...
            >
                ...
                <h2 class="title" style="color: #f25a57; font-size: 1.7rem">
                    !مرحبا بكم فى توريدات دوت كوم
                </h2>
                <p class="name" style="margin-top: -20px; font-size: 1.5rem">
                    مرحبا ({{$order->name}})
                </p>
                <p style="font-size: 1.3rem">
                    <b>يسعدنا انضمامك إلينا كاحد عملائنا الكرام٠</b>
                </p>
            </td>
        </tr>
        ...
        <tr>
            <td class="paragraph" style="padding-right: 10px" colspan="2">
                <p
                        ...
                        lang="ar"
                >
                    نحن موقع الكتروني مصمم خصيصا لمساعدتك فى إنهاء مشاريعك بسهولة٠<br />
                    نقدم مجموعة واسعة من المنتجات من فئات مثل
                    <b>الكهرباء و السباكة و الدهانات و التكيفات٠</b>
                    <br /><br />

                    كمشترك جديد إستمتع بعروض وتحديثات حصرية على أحدث منتجاتنا٠ نؤكد لك
                    أننا سنوفر لك تجربة تسوق ممتعة و خالية من المتاعب٠
                    <br /><br />

                    في توريدات دوت كوم، نتفهم أهمية الجوده و الكفاءة، و نضمن أن
                    منتجاتنا تلبي أعلى المعايير٠
                    <br />
                    كما نضمن بالتزامنا بتزويدك بمنتجات امنة و موثوقة و بأحسن الاسعار٠
                    <br /><br />
