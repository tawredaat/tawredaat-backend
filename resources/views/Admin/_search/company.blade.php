...
@section('search-company-active', 'm-menu__item--active') 
@section('page-title', 'Search Store|Companies')
@section('content')
<style type="text/css">
  .swal2-confirm{
...
<div class="m-grid__item m-grid__item--fluid m-grid m-grid--ver-desktop m-grid--desktop m-body">
  ...
  <div class="m-grid__item m-grid__item--fluid m-wrapper">
    ...
    <div class="m-content">
      <div class="row">
        <form method="get" id="Excel" action="{{route('companies.search.file')}}"
      ...
      <div class="m-portlet m-portlet--mobile">
        ...
        <div class="m-portlet__body">
          <div class="table-responsive">
            <!--begin: Datatable -->
            <table class="table table-striped- table-bordered table-hover table-checkable" id="companies-search-table">
              <thead>
                <tr>
                  <th>Company Name
                  </th>
...
<script type="text/javascript">
      function render(url) {
       $("#companies-search-table").dataTable({
          "order": [[ 1, "desc" ]],
          processing: true,
          serverSide: true,
          ajax: url,
    ...
    @if(request()->has('start_date') && request()->has('end_date'))
      render("{!! route('search.store.companies').'?start_date='.request()->input('start_date').'&end_date='.request()->input('end_date')!!}");
    @else
      render("{!! route('search.store.companies')!!}");
    @endif
</script>
@endpush
@endsection
