...
@section('search-brand-active', 'm-menu__item--active') 
@section('page-title', 'Search Store|Brands')
@section('content')
<style type="text/css">
  .swal2-confirm{
...
<div class="m-grid__item m-grid__item--fluid m-grid m-grid--ver-desktop m-grid--desktop m-body">
  ...
  <div class="m-grid__item m-grid__item--fluid m-wrapper">
    ...
    <div class="m-content">
      <div class="row">
        <form method="get" id="Excel" action="{{route('brands.search.file')}}"
      ...
      <div class="m-portlet m-portlet--mobile">
        ...
        <div class="m-portlet__body">
          <div class="table-responsive">
            <!--begin: Datatable -->
            <table class="table table-striped- table-bordered table-hover table-checkable" id="brands-search-table">
              <thead>
                <tr>
                  <th>Brand Name
                  </th>
...
<script type="text/javascript">
    ...
    @if(request()->has('start_date') && request()->has('end_date'))
      render("{!! route('search.store.brands').'?start_date='.request()->input('start_date').'&end_date='.request()->input('end_date')!!}");
    @else
      render("{!! route('search.store.brands')!!}");
    @endif
</script>
@endpush
@endsection
