					...
					<div class="row">
						<div class="col-lg-12">
							...
							<div class="m-portlet">
								...
								<!--begin::Form-->
								<form method="POST" action="{{route('banners.home.store')}}" class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" enctype="multipart/form-data">
									@csrf
									<div class="m-portlet__body">
										...
										<div class="form-group m-form__group row">
											<div class="col-lg-12">
												<label class="">URL En:</label>
												<input type="text" value="{{old('urlEn')}}" name="urlEn"  required="" class="form-control m-input" placeholder="URL In English...">
												@error('urlEn')
	                                                <span class="invalid-feedback" role="alert">
	                                                        <strong>{{ $message }}</strong>
	                                                    </span>
									    ...
									    <div class="form-group m-form__group row">
											<div class="col-lg-12">
												<label class="">URL Ar:</label>
												<input type="text" value="{{old('urlAr')}}" name="urlAr"  required="" class="form-control m-input" placeholder="URL In Arabic...">
												@error('url')
	                                                <span class="invalid-feedback" role="alert">
	                                                        <strong>{{ $message }}</strong>
	                                                    </span>
										...
										<div class="form-group m-form__group row">
                                            <div class="col-lg-12">
                                                ...
                                                <select name="section" class="form-control m-input" required>
                                                    <option value="1" {{ old('option') == 1 ? 'selected' : '' }}>Slider</option>
                                                    <option value="2" {{ old('option') == 2 ? 'selected' : '' }}>First Section Banners</option>
                                                    <option value="3" {{ old('option') == 3 ? 'selected' : '' }}>Second Section Banners</option>
                                                    <option value="4" {{ old('option') == 4 ? 'selected' : '' }}>third Section Banners</option>
                                                </select>
                                                @error('option')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
