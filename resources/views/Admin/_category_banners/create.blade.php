					...
					<div class="row">
						<div class="col-lg-12">
							...
							<div class="m-portlet">
								...
								<!--begin::Form-->
								<form method="POST" action="{{route('category-banners.store')}}" class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" enctype="multipart/form-data">
									@csrf
										...
										<div class="form-group m-form__group row">
                                            <div class="col-lg-12">
                                                ...
                                                <select name="section" class="form-control m-input" required>
                                                    <option value="1" {{ old('option') == 1 ? 'selected' : '' }}>Main Banner</option>
                                                    <option value="2" {{ old('option') == 2 ? 'selected' : '' }}>Ads # 1</option>
                                                    <option value="3" {{ old('option') == 3 ? 'selected' : '' }}>Ads # 2</option>
                                                    <option value="4" {{ old('option') == 4 ? 'selected' : '' }}>Ads # 3</option>
                                                </select>
                                                @error('option')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
