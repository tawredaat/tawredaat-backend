					...
					<div class="row">
						<div class="col-lg-12">
							...
							<div class="m-portlet">
								...
								<!--begin::Form-->
								<form method="POST" action="{{route('admins.store')}}" class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed">
									@csrf
									<div class="m-portlet__body">
										<div class="form-group m-form__group row">
											<div class="col-lg-6">
												<label>Full Name:</label>
												<input type="text" value="{{old('name')}}" name="name" required="" class="form-control m-input" placeholder="Enter full name...">
												@error('name')
											...
											<div class="col-lg-6">
												...
												<input type="email" value="{{old('email')}}" name="email"  required="" class="form-control m-input" placeholder="Enter email...">
												@error('email')
	                                                <span class="invalid-feedback" role="alert">
	                                                        <strong>{{ $message }}</strong>
	                                                    </span>
										...
										<div class="form-group m-form__group row">
											<div class="col-lg-6">
												...
												<div class="m-input-icon m-input-icon--right">
													<input name="password" required="" type="password" class="form-control m-input" placeholder="Enter your password...">
												</div>
												@error('password')
	                                                <span class="invalid-feedback" role="alert">
	                                                        <strong>{{ $message }}</strong>
