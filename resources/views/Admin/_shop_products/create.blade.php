                                    ...
                                    <form method="POST" action="{{ route('shop.products.store') }}"
                                        ...
                                        <div class="m-portlet__body">
                                            ...
                                            <div class="form-group m-form__group row">
                                                ...
                                                <div class="col-lg-4">
                                                    <label class="" for="soled">Sold By
                                                        {{ config('global.used_app_name', 'Tawredaat') }} :</label>
                                                    <input type="checkbox" id="soled" name="soled_by_souq"
                                            ...
                                            <div class="form-group m-form__group row">
                                                <div class="col-lg-6">
                                                    ...
                                                    <input type="number" value="{{ old('from') }}"
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    <input type="number" value="{{ old('to') }}"
                                            ...
                                            <div class="form-group m-form__group row">
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    <input type="file" name="mobileimg" required=""
                                                        class="form-control m-input">
                                                    @error('mobileimg')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
