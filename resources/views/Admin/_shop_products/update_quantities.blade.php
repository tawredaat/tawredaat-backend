...
@section('shop-products-update-quantities-active', 'm-menu__item--active')
@section('page-title', 'Shop | Products | Update Quantities')
<style type="text/css">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="m-portlet">
                                    ...
                                    <form method="post" enctype="multipart/form-data"
                                        ...
                                        action="{{ route('shop.products.update.quantities') }}">
                                        @csrf
