...
@section('brand-store-banners-create-active', 'm-menu__item--active')
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="m-portlet">
                                    ...
                                    <!--begin::Form-->
                                    <form method="POST" action="{{ route('brand-store-banners.store') }}"
                                        ...
                                        <div class="m-portlet__body">
                                            <div class="form-group m-form__group row">
                                                <div class="col-lg-6">
                                                    ...
                                                    <input type="file" value="{{ old('image_ar') }}" name="image_ar"
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    <input type="file" value="{{ old('image_en') }}" name="image_en"
                                                        required="" class="form-control m-input">
                                                    @error('image_en')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                            ...
                                            <div class="form-group m-form__group row">
                                                <div class="col-lg-6">
                                                    ...
                                                    <input type="file" value="{{ old('mobile_image') }}"
                                                        name="mobile_image" required="" class="form-control m-input">
                                                    @error('mobile_image')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                            ...
                                            <div class="form-group m-form__group row">
                                                <div class="col-lg-6">
                                                    ...
                                                    <input type="text" value="{{ old('url') }}" name="url"
                                                        required="" class="form-control m-input" placeholder="URL...">
                                                    @error('url')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
