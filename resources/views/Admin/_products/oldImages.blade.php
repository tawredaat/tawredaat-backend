...
@section('page-title', 'Products|Images')
@push('style')
<style type="text/css">
	    .bootstrap-tagsinput {
        ...
        <div class="m-grid__item m-grid__item--fluid m-wrapper">
         ...
         <div class="m-subheader ">
          ...
          <div class="m-content">
              ...
              <!--begin::Form-->
                <form method="POST" action="{{route('products.uploadImages',$product->id)}}" class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" enctype="multipart/form-data">
                  @csrf
                  <hr style="margin:0">
           ...
           Swal.fire({
            ...
            confirmButtonText: 'Yes, delete it!'
              ...
              if (result.value) {
                ...
                var urls = "{{ route('products.deleteImage',['id'=>'id','image'=>'photo']) }}";
