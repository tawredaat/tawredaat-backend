...
@section('products-create-active', 'm-menu__item--active')
					...
					<div class="row">
						<div class="col-lg-12">
							...
							<div class="m-portlet">
								...
								<!--begin::Form-->
								<form method="POST" action="{{route('products.store')}}" class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" enctype="multipart/form-data">
									@csrf
									<div class="m-portlet__body">
										...
										<div class="form-group m-form__group row">
											<div class="col-lg-6">
												...
												<input type="text" class="form-control" id="keywords_meta_en" name="keywords_meta_en" placeholder="keywords Meta in english..." value="{{ old('keywords_meta_en') }}">
											...
											<div class="col-lg-6">
												...
												<input type="text" class="form-control" id="keywords_meta_ar" name="keywords_meta_ar" placeholder="keywords Meta in arabic..." value="{{ old('keywords_meta_ar') }}">
										...
										<div class="form-group m-form__group row">
											<div class="col-lg-6">
												...
												<input type="text" name="video" value="{{ old('video') }}"   class="form-control m-input" placeholder="Video Link.." >
												@error('video')
                                                    <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
											...
											<div class="col-lg-6">
												...
												<input type="text" name="sku_code" value="{{ old('sku_code') }}"   class="form-control m-input" placeholder="SKU code..." >
												@error('sku_code')
                                                    <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
