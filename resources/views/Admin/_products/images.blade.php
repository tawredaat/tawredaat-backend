                                ...
                                <div class="m-portlet">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-10 offset-sm-1">
                                            <h2 class="page-heading">Upload Product Images <span id="counter"></span></h2>
                                            ...
                                            <div class="table-resposive" style="padding: 60px">
                                                ...
                                                <div
                                                    ...
                                                    <form method="post" id="deleteForm"
                                                        action="{{ route('products.delete.selected.image') }}"
    ...
    @push('script')
        <script type="text/javascript">
            ...
            $('#ProductsImages').DataTable({
                ...
                'paging': true,
                'info': true,
                "ajax": "{{ route('product.images.view', $product->id) }}",
                "columns": [{
            ...
            //upload images
            UploadImages("{{ route('products.uploadImages', $product->id) }}", "{{ csrf_token() }}");
            //delete image
            var CSRF_TOKEN = $('meta[name="csrf-token"]').attr('content');
            $("#ProductsImages").on('click', '.delete', function() {
                var content = $(this).data("content");
                var urls = "{{ route('products.deleteImage', 'id') }}";
