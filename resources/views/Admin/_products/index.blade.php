...
@section('content')
                    ...
                    <div class="m-portlet__body">
                        <section class="content">
                            ...
                            <div
                                ...
                                <form method="post" id="deleteForm" action="{{route('products.delete.selected')}}"
                                ...
                                <form method="post" id="deleteAll" action="{{route('products.delete.all')}}">
                                    @csrf
                                    <div class="form-group m-form__group">
    ...
    @push('script')
        <script type="text/javascript">
            ...
            $("#products-table").on('click', '.delete', function () {
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        var urls = "{{ route('products.destroy','id' ) }}";
            ...
            render("{!! route('products.new.index',['start_date'=> request()->input('start_date'),'end_date'=> request()->input('end_date')])!!}");
            ...
            $('#searchButton').on('click', function (event) {
                event.stopPropagation();
                render("{{route('products.new.index')}}?column="
