...
@section('shop-banners-view-active', 'm-menu__item--active')
								...
								<div class="m-portlet__head-tools">
									<ul class="m-portlet__nav">
										<li class="m-portlet__nav-item">
											<a href="{{route('shop.banners.create')}}" class="btn btn-primary m-btn m-btn--pill m-btn--custom m-btn--icon m-btn--air">
												<span>
       ...
       "columns":[
          {
...

            {
              "mRender": function ( data, type, row )
              {
                var url = "{{ route('shop.banners.edit','id' ) }}";
           ...
           Swal.fire({
            ...
            confirmButtonText: 'Yes, delete it!'
              ...
              if (result.value) {
                ...
                var urls = "{{ route('shop.banners.destroy','id' ) }}";
