@extends('Admin.index')
@section('quantity-active', 'm-menu__item--active m-menu__item--open')
@section('quantity-view-active', 'm-menu__item--active')
@section('page-title', 'Quantity Types|View')
@section('content')
    <style type="text/css">
        .swal2-confirm{
                        ...
                        <div class="m-portlet__head-tools">
                            <ul class="m-portlet__nav">
                                <li class="m-portlet__nav-item">
                                    <a href="{{route('quantityTypes.create')}}" class="btn btn-primary m-btn m-btn--pill m-btn--custom m-btn--icon m-btn--air">
												<span>
													<i class="
													la la-plus"></i>
													<span>New Quantity Type</span>
												</span>
                                    </a>
                                </li>
                            </ul>
    ...
    @push('script')
        <script type="text/javascript">
            $('#productSpecs').DataTable({
                ...
                "columns":[
                    ...
                    },
                    {
                        ...
                        {
                            var url = "{{ route('quantityTypes.edit','id' ) }}";
            ...
            $("#productSpecs").on('click', '.delete', function(){
                Swal.fire({
                    title: 'Are you sure to delete this quantity type?',
                    ...
                    if (result.value) {
                        ...
                        var urls = "{{ route('quantityTypes.destroy','id' ) }}";
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                ...
                                Swal.fire(
                                    'Deleted!',
                                    'quantity type has been deleted.',
                                    'success'
                                )
                            }
                            ,error:function(data){
