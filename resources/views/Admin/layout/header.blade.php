                  ...
                  <div class="m-stack__item m-brand  m-brand--skin-light ">
                      <div class="m-stack m-stack--ver m-stack--general">
                          <div class="m-stack__item m-stack__item--middle m-brand__logo">
                              <a style="font-weight: bold;font-size: 25px;color: #fff" href="{{ route('admin.home') }}"
                                              ...
                                              <div class="m-dropdown__header m--align-center"
                                                  ...
                                                  <div class="m-card-user m-card-user--skin-light">
                                                      ...
                                                      <div class="m-card-user__details">
                                                          <span
                                                              class="m-card-user__name m--font-weight-500">{{ auth('admin')->user()->name }}</span>
                                                          <a href="{{ route('admins.edit', auth('admin')->user()->id) }}"
                                                              class="m-card-user__email m--font-weight-300 m-link">{{ auth('admin')->user()->email }}</a>
                                                      </div>
                                                  </div>
                                              </div>
