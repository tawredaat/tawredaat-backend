					...
					<div class="row">
						<div class="col-lg-12">
							...
							<div class="m-portlet">
								...
								<!--begin::Form-->
								<form method="POST" action="{{route('bundel.banners.store')}}" class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" enctype="multipart/form-data">
									@csrf
										...
										<div class="form-group m-form__group row">
                                            <div class="col-lg-12">
                                                ...
                                                <select name="section" class="form-control m-input" required>
                                                    <option value="10" {{ old('option') == 10 ? 'selected' : '' }}>Main Banner</option>
                                                </select>
                                                @error('option')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
