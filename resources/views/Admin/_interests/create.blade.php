...
@section('interests-create-active', 'm-menu__item--active')
@section('page-title', 'Interests | Create')
@section('content')
<style>
    .invalid-feedback {
        display: block;
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="m-portlet">
                                ...
                                <!--begin::Form-->
                                <form method="POST" action="{{route('interests.store')}}" class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed">
                                    @csrf
