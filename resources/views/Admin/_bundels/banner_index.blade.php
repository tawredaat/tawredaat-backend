...
@section('page-title', 'Bundel Banners|View')
@section('content')
<style type="text/css">
  .swal2-confirm {
          ...
          <div class="m-portlet__head-tools">
            <ul class="m-portlet__nav">
              <li class="m-portlet__nav-item">
                <a href="{{route('bundel.banners.create')}}" class="btn btn-primary m-btn m-btn--pill m-btn--custom m-btn--icon m-btn--air">
                  <span>
...
<script type="text/javascript">
  $('#banners').DataTable({
    ...
    'paging': true,
    'info': true,
    "ajax": "{{ route('admin.bundel.banners') }}",
    "columns": [{
        "data": "id"
      },
      {
