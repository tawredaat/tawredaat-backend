...
@section('countries-view-active', 'm-menu__item--active') 
@section('page-title', 'Countries|View') 
@section('content')
<style type="text/css">
  .swal2-confirm{
        ...
        <div class="m-content">
                        ...
                        <div class="m-portlet m-portlet--mobile">
                          ...
                          <div class="table-responsive">
                                <!--begin: Datatable -->
                                <table class="table table-striped- table-bordered table-hover table-checkable" id="countries">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                            <th>Flag</th>
 ...
 <script type="text/javascript">
  $('#countries').DataTable({
       ...
       "serverSide": true,
        'paging'      : true,
        'info'        : true,
       "ajax": "{{ route('countries.countries') }}",
       "columns":[
          { 
              "data": "id"
             },
            {
              ...
              {
                var img = "{{ asset('storage/flag') }}";
                img = img.replace('flag', row['flag']);
       ...
       var CSRF_TOKEN = $('meta[name="csrf-token"]').attr('content');
        $("#countries").on('click', '.delete', function(){
           Swal.fire({
            ...
            confirmButtonText: 'Yes, delete it!'
              ...
              if (result.value) {
                ...
                var urls = "{{ route('countries.destroy','id' ) }}";
