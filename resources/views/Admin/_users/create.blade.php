...
@section('users-create-active', 'm-menu__item--active')
@section('page-title', 'Users|Create')
@section('content')
    <style>
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    <div class="m-input-icon m-input-icon--right">
                                                        <input name="title" type="text" value="{{ old('title') }}"
                                                            class="form-control m-input" placeholder="Enter user title...">
                                                        @error('title')
                                                            <span class="invalid-feedback" role="alert">
                                                                <strong>{{ $message }}</strong>
                                                            </span>
                                                ...
                                                <div class="col-lg-12">
                                                    ...
                                                    <div class="m-input-icon m-input-icon--right">
                                                        <input name="photo" required type="file"
                                                            class="form-control m-input" placeholder="Enter your Photo">
                                                        @error('photo')
                                                            <span class="invalid-feedback" role="alert">
                                                                <strong>{{ $message }}</strong>
                                                            </span>
