                                ...
                                <tbody>
                                    ...
                                    @foreach ($categories as $category)
                                        <tr id="tr-{{ $category->id }}">
                                            ...
                                            <td>{{ $category->name }}</td>
                                            <td>
                                                <a style="padding: 10px;background: #2c2e3e;color: #fff;font-weight: bold;border-radius: 50%;"
                                                    target="_blank" title="view the products"
                                                    href="{{ route('shop.products.index') . '?l3=' . $category->id }}">
                                                    <span>{{ $category->shopProducts->count('id') }}</span>
                                                </a>
                                            </td>
                                            <td>
