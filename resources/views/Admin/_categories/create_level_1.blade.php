                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="m-portlet">
                                    ...
                                    <!--begin::Form-->
                                    <form method="POST" action="{{ route('categories.store-level-1') }}"
                                        ...
                                        <div class="m-portlet__body">
                                            ...
                                            <div class="form-group m-form__group row">
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <input type="text" name="alt_en" required=""
                                                        value="{{ old('alt_en') }}" class="form-control m-input"
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <input type="text" name="alt_ar" required=""
                                                        value="{{ old('alt_ar') }}" class="form-control m-input"
                                            ...
                                            <div class="form-group m-form__group row">
                                                <div class="col-lg-6">
                                                    ...
                                                    <input id="keywords_en" type="text" name="keywords_en"
                                                        placeholder="keywords in english..."
                                                        value="{{ old('keywords_en') }}" class="form-control">
                                                    @error('keywords_en')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    <input id="keywords_ar" type="text" name="keywords_ar"
                                                        placeholder="keywords in arabic..."
                                                        value="{{ old('keywords_ar') }}" class="form-control">
                                                    @error('keywords_ar')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                            ...
                                            <div class="form-group m-form__group row">
                                                <div class="col-lg-6">
                                                    ...
                                                    <input id="keywords_meta_en" type="text" name="keywords_meta_en"
                                                        placeholder="keywords Meta in english..."
                                                        value="{{ old('keywords_meta_en') }}" class="form-control">
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    <input id="keywords_meta_ar" type="text" name="keywords_meta_ar"
                                                        placeholder="keywords Meta in arabic..."
                                                        value="{{ old('keywords_meta_ar') }}" class="form-control">
