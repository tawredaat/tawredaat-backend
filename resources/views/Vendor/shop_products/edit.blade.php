                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="m-portlet">
                                    ...
                                    <!--begin::Form-->
                                    <form method="POST" action="{{ route('vendor.shop-products.update', $product->id) }}"
                                            ...
                                            <div class="form-group m-form__group row">
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <input type="checkbox" id="check"
                                                        {{ $product->sold_by_souqkahrba ? 'checked' : '' }}
                                                        name="sold_by_souq" value="1" class="form-control m-input">
                                                    @error('sold_by_souq')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                            ...
                                            <div class="form-group m-form__group row">
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    <input type="file" name="mobile_img"
                                                        class="form-control m-input"><br>
                                                    @if ($product->mobile_img)
                                                        <img alt="image-not-found"
                                                            src="{{ asset('storage/' . $product->mobile_img) }}"
                                                            width="80">
                                                    @endif
                                                    @error('mobile_img')
                                                        <span class="invalid-feedback" role="alert">
