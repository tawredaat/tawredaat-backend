                                    ...
                                    <div class="m-portlet__head">
                                        <div class="m-portlet__head-caption">
                                            <div class="m-portlet__head-title">
                                                ...
                                                <h3 class="m-portlet__head-text"> {{ $sub_title }} {{ $product->name }}
                                                </h3>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="table-resposive" style="padding: 60px">
                                                ...
                                                <div
                                                    ...
                                                    <form method="post" id="deleteForm"
                                                        action="{{ route('vendor.shop-product-images.delete-selected') }}"
    ...
    @push('script')
        <script type="text/javascript">
            ...
            $('#ProductsImages').DataTable({
                ...
                'paging': true,
                'info': true,
                "ajax": "{{ route('vendor.shop-product-images.get-images', $product->id) }}",
                "columns": [{
            ...
            //upload images
            UploadImages("{{ route('vendor.shop-product-images.upload', $product->id) }}", "{{ csrf_token() }}");
            //delete image
            var CSRF_TOKEN = $('meta[name="csrf-token"]').attr('content');
            $("#ProductsImages").on('click', '.delete', function() {
                var content = $(this).data("content");
                var urls = "{{ route('vendor.shop-product-images.delete', 'id') }}";
