    ...
    @push('script')
        <script type="text/javascript">
            ...
            $('#ProductsImages').DataTable({
                ...
                'paging': true,
                'info': true,
                "ajax": "{{ route('vendor.shop-product-mass-images.data') }}",
                "columns": [{
                    "data": "id"
                }, {
            ...
            Dropzone.options.myDropzone = {
                url: '{{ route('vendor.shop-product-mass-images.upload') }}',
                init: function() {
                    var th = this;
            ...
            $("#ProductsImages").on('click', '.delete', function() {
                ...
                var urls = "{{ route('vendor.shop-product-mass-images.delete', 'id') }}";
