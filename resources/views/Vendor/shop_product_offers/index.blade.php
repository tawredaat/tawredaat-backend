...
@section('content')
                        ...
                        <section class="content">
                            ...
                            <div style="display: flex;justify-content: flex-start;align-items:flex-start;">
                                <form method="post" id="deleteForm"
                                    action="{{ route('vendor.shop-products.delete-selected') }}" style="margin-right: 3px">
                                    @csrf
                                    <div class="form-group m-form__group">
                                ...
                                <form method="post" id="deleteAll" style="background-color: azure"
                                    action="{{ route('vendor.shop-products.delete-all') }}">
                                    @csrf
                                    <div class="form-group m-form__group">

                                        <button class="btn btn-danger" onclick="return deleteAllSure(event)" type="submit">
                                            Delete All Product
                                        </button>
                                    </div>
                                </form>
    ...
    @push('script')
        <script type="text/javascript">
            ...
            $("#products-table").on('click', '.delete', function() {
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        var urls = "{{ route('vendor.shop-product-offers.remove-from-offers', 'id') }}";
            ...
            render("{!! route('vendor.shop-product-offers.data', [
            ...
            $('#searchButton').on('click', function(event) {
                event.stopPropagation();
                render("{{ route('vendor.shop-product-offers.index') }}?column=" +
