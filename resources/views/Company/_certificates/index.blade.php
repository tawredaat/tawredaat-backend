...
@section('certificates-view-active', 'm-menu__item--active') 
@section('page-title', 'Certificates|View') 
@section('content')
<style type="text/css">
  .swal2-confirm{
      ...
      <div class="m-grid__item m-grid__item--fluid m-grid m-grid--ver-desktop m-grid--desktop m-body">
		...
		<div class="m-content">
								...
								<div class="m-portlet__head-tools">
									<ul class="m-portlet__nav">
										<li class="m-portlet__nav-item">
											<a href="{{route('company.certificate.create')}}" class="btn btn-primary m-btn m-btn--pill m-btn--custom m-btn--icon m-btn--air">
												<span>
                ...
                <div class="table-resposive">
    								<!--begin: Datatable -->
    								<table class="table table-striped- table-bordered table-hover table-checkable" id="certificates">
    									<thead>
    										<tr>
                          <th>Certificate</th>
    										  <th>Name</th>
 ...
 <script type="text/javascript">
  $('#certificates').DataTable({
       ...
       "serverSide": true,
        'paging'      : true,
        'info'        : true,
       "ajax": "{{ route('company.certificates') }}",
       "columns":[
            {
              "mRender": function ( data, type, row ) 
              {
                var url = "{{ asset('storage/PDF###') }}";
                url = url.replace('PDF###', row['name']);
           ...
           Swal.fire({
            ...
            confirmButtonText: 'Yes, delete it!'
              ...
              if (result.value) {
                ...
                var urls = "{{ route('company.certificate.destroy','id' ) }}";
