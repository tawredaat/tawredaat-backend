                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="m-portlet">
                                ...
                                <!--begin::Form-->
                                <form method="POST" action="{{route('company.companies.update',$company->id)}}" class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" enctype="multipart/form-data">
                                    @method('put') @csrf
                                    <div class="m-portlet__body">
                                        ...
                                        <div class="form-group m-form__group row">
                                            ...
                                            <div class="col-lg-3">
                                                ...
                                                <input type="text" value="{{ old('whatsup_number')? old('whatsup_number'):$company->whatsup_number }}" name="whatsup_number" placeholder="whatsup number" class="form-control m-input"> @error('whatsup_number')
                                                <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                    </span> @enderror
                                            </div>
...
<div class="form-group m-form__group row">
    ...
    @push('script')
     <script type="text/javascript">
        ...
        $('#keyword_meta_en,#keyword_meta_ar, #keyword_en').tagsinput({
            confirmKeys: [13, 188]
          });
