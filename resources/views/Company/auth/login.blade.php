...
<head>
    <meta charset="utf-8" />
    <title>{{ config('global.used_app_name', 'Tawredaat') }} | Login as Company</title>
...
<body
    ...
    <div class="m-grid m-grid--hor m-grid--root m-page">
        <div class="m-grid__item m-grid__item--fluid m-grid m-grid--hor m-login m-login--signin m-login--2 m-login-2--skin-3"
            id="m_login"
            style="background-image: url({{ url('/') }}/frontend_plugins/assets/app/media/img//bg/bg-2.jpg);">
                ...
                <div class="m-login__container">
                    ...
                    <div class="m-login__signin">
                        <div class="m-login__head">
                            <h3 class="m-login__title">Sign In To Company</h3>
                        </div>
                        <form action="{{ route('company.login') }}" method="post" id="login-form-admin"
    ...
    @include('Company.layout.messages')
    <!--end::Page Scripts -->
</body>
