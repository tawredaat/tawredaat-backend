					...
					<div class="row">
						<div class="col-lg-12">
							...
							<div class="m-portlet">
								...
								<!-- Multistep Form -->
								<div class="main">
								<form action="{{route('company.selectedL2Categories')}}" class="regform" method="get">
									@csrf
								...
								<fieldset id="first" style="width: 100%">
									<h2 class="title">Select category(level two)</h2>
									<p class="subtitle">Step three</p>
									<div class="form-group">
										<select required="" multiple="" style="height: 20px" data-live-search="true" data-actions-box="true"  id="idSelect" name="categories[]" id="" class="form-control selectpicker ">
											...
											<optgroup style="font-weight: bold;" label="{{$L1category->translate('en')->name}}-{{$L1category->translate('ar')->name}}">
												@foreach($l2Categories as $category)
													@if($category && $category->parent == $L1category->id)
