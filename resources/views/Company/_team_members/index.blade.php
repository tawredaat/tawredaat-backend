...
@section('members-view-active', 'm-menu__item--active') 
@section('page-title', 'Team Members|View') 
@section('content')
<style type="text/css">
  .swal2-confirm{
      ...
      <div class="m-grid__item m-grid__item--fluid m-grid m-grid--ver-desktop m-grid--desktop m-body">
		...
		<div class="m-content">
								...
								<div class="m-portlet__head-tools">
									<ul class="m-portlet__nav">
										<li class="m-portlet__nav-item">
											<a href="{{route('company.members.create')}}" class="btn btn-primary m-btn m-btn--pill m-btn--custom m-btn--icon m-btn--air">
												<span>
            ...
            <div class="table-responsive">
								<!--begin: Datatable -->
								<table class="table table-striped- table-bordered table-hover table-checkable" id="members">
									<thead>
										<tr>
										  <th>Image</th>
										  <th>Name</th>
  ...
  $('#members').DataTable({
       ...
       "columns":[
             ...
             },
            {
              "mRender": function ( data, type, row ) 
              {
                var url = "{{ route('company.members.edit','id' ) }}";
           ...
           Swal.fire({
            ...
            confirmButtonText: 'Yes, delete it!'
              ...
              if (result.value) {
                ...
                var urls = "{{ route('company.members.destroy','id' ) }}";
