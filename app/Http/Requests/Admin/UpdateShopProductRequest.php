...
class UpdateShopProductRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'image_name1'=>'nullable|image|mimes:jpg,jpeg,png,gif,bmp,webp',
            'image_name2'=>'nullable|image|mimes:jpg,jpeg,png,gif,bmp,webp',
            'image_name3'=>'nullable|image|mimes:jpg,jpeg,png,gif,bmp,webp',
            ...
            'qty_type'=>'required|exists:quantity_types,id',
            'soled_by_souq'=>'nullable|boolean',
        ];
    }
}
