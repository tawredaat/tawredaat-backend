...
class DataAction
{
    public function execute(Request $request)
    {
        ...
        $products = VendorShopProduct::vendorShopProducts()->where('old_price', '>', 'new_price')->whereNotNull('new_price')->when($request->input('column'), function ($query) use ($request) {
